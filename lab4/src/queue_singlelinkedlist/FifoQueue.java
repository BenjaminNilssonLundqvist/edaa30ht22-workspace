...
public class FifoQueue<E> extends AbstractQueue<E> implements Queue<E> {
	...
	public void append(FifoQueue<E> q){
		if(this==q || (this.last==null && q.last==null)){
			...
			this.last=q.last;
			this.size=q.size(); // q.size or q.size() ?? fråga
		} else if (q.last!=null){
	...
	private class QueueIterator implements Iterator<E> {
		...
		public E next() {
			...
			if (pos.next.equals(last)) { // vid slute, retunera sista elementet och sätt resten till null
				E element = pos.next.element;
				pos = null;
				return element;
			}
			pos = pos.next; // Går igenom noderna
			return pos.element;
		}
	}
